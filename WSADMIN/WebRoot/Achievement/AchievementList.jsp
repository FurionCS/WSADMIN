			    	  ...
			    	  $.ajax({
			              ...
			              success: function (result) {  
			            	  if (result.code == 1) {
			            		  ...
			            		  $noty.close();
			            		  noty({ text: "清空失败！", type: "warning", layout: "topCenter", timeout: 1000, modal: true }); 
			            	  }
			              }
			    	  })
                    }
                   ...
                   count = result.count;
                    ...
                    for (var i = 0; i < data.length; i++) {
                       ...
                       /*  html += '<td class="sorting_1"><div class="checker"><span><input type="checkbox" onclick="checkItem(this);" class="checkboxes" value=' + data[i][0] + '></span></div></td>'; */
                        ...
                        html += '<td class="hidden-480">' + data[i].money + '</td>';
                        html += '<td class="hidden-480">' + data[i].teambonus+ '</td>';
                        html += '<td class="hidden-480">' + data[i].personmoney + '</td>';
                        html += '<td class="hidden-480">' + data[i].personbonus  + '</td></tr>';
                    }
                    $("#ListBody").html(html);
                }
                else {
